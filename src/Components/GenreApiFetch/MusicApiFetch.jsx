...
const GENRE_ID = '10402' // The genre ID for horror movies

function MusicApiFetch() {
  ...
  if (error) {
    return <div>Error loading music movies. Please try again later.</div>
  }
