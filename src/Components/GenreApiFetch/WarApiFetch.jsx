...
const GENRE_ID = '10752' // The genre ID for horror movies

function WarApiFetch() {
  ...
  if (error) {
    return <div>Error loading War movies. Please try again later.</div>
  }
