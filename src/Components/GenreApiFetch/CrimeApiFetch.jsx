...
const GENRE_ID = '80' // The genre ID for horror movies

function CrimeApiFetch() {
  ...
  if (error) {
    return <div>Error loading Crime movies. Please try again later.</div>
  }
