...
const GENRE_ID = '14' // The genre ID for horror movies

function FantasyApiFetch() {
  ...
  if (error) {
    return <div>Error loading Fantasy movies. Please try again later.</div>
  }
...
export default FantasyApiFetch
