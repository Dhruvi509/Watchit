...
const GENRE_ID = '53' // The genre ID for horror movies

function ThrillerApiFetch() {
  ...
  if (error) {
    return <div>Error loading Thriller movies. Please try again later.</div>
  }
...
export default ThrillerApiFetch