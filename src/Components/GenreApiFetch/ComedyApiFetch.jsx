...
const GENRE_ID = '35' // The genre ID for horror movies

function ComedyApiFetch() {
  ...
  if (error) {
    return <div>Error loading Comedy movies. Please try again later.</div>
  }
