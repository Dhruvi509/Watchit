...
const GENRE_ID = '878' // The genre ID for horror movies

function ScienceFictionApiFetch() {
  ...
  if (error) {
    return <div>Error loading science fiction movies. Please try again later.</div>
  }
...
export default ScienceFictionApiFetch