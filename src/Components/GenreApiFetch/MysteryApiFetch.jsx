...
const GENRE_ID = '9648' // The genre ID for horror movies

function MysteryApiFetch() {
  ...
  if (error) {
    return <div>Error loading mystery movies. Please try again later.</div>
  }
...
export default MysteryApiFetch