...
const GENRE_ID = '99' // The genre ID for horror movies

function DocumentaryApiFetch() {
  ...
  if (error) {
    return <div>Error loading documentary movies. Please try again later.</div>
  }
...
export default DocumentaryApiFetch
