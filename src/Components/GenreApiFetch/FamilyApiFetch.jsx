...
const GENRE_ID = '10751' // The genre ID for horror movies

function FamilyApiFetch() {
  ...
  if (error) {
    return <div>Error loading Family movies. Please try again later.</div>
  }
