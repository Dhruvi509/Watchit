...
const GENRE_ID = '36' // The genre ID for horror movies

function HistoryApiFetch() {
  ...
  if (error) {
    return <div>Error loading History movies. Please try again later.</div>
  }
...
export default HistoryApiFetch
